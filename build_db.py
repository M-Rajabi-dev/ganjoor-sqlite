...
def build_indices_and_fts(con):
    ...
    cur.execute("CREATE VIRTUAL TABLE verses_fts USING fts5(text, poem_id UNINDEXED, content='verses', content_rowid='id', tokenize='unicode61', columnsize=0);")
...
def main():
    ...
    parser.add_argument("--output", default="ganjoor.sqlite")
